...
"ℛ":["R","script"],"ℯ":["e","script"],"ℊ":["g","script"],"ℴ":["o","script"]};var Z={",":".17em",":":".22em",";":".28em","!":"-.17em"};e.dtableQ=!1,e.macro1s_={mtd:C,rowspan:k,colspan:T,mtr:L,dtable:E(S,!0),ttable:E(S,!1),table:E(S,null),math:I};var J={_:"sub","^":"sup","↙":"under","↖":"over"};return e.sMxAToMe=function(t,r){r||(r=document),e.infix_[""]&&e.infix_[","]||E.err(err_sToMe_1_),null==e.MathML&&(e.MathML=e.canMathML()),e.re_.lastIndex=0,V="",Q=Array.isArray(t)?t:[t],W=0,H=r,X=e.infix_[""];var n=j(0);if(n[1])throw"Extra input:  "+n[1][1]+V.substring(e.re_.lastIndex)+(W<Q.length?"...":"");return(e.re_.lastIndex<V.length||W<Q.length)&&E.err(err_sToMe_2_),n[0]||l()},e.sToMathE=function(t,r,n){var a=e.sMxAToMe(t,n);return E.elem(e.mtagName(a),["math","fmath"])||(a=e.newMe("math",a,n)),"string"==typeof t&&a.setAttribute("alttext",t),e.setMathBlockQ(a,r)},e.$mathQ=!0,e.inline$$Q=!1,e.parseMath=function(t){if(1==t.nodeType&&"SCRIPT"!=t.tagName)if("MATH"==t.tagName.toUpperCase()){var r=e.eToMathE(t);r!=t&&t.parentNode.replaceChild(r,t)}else for(var n=t.firstChild;n;){var a=n.nextSibling;e.parseMath(n),n=a}else if(3==t.nodeType&&/[$\\]/.test(t.data)){for(var i=t.ownerDocument,s=t.data,o=[],l="",u=/\\([$\\])|\$\$?|\\[([]/g;;){var m=u.lastIndex,f=u.exec(s),c=f?f.index:s.length;if(c>m&&(l+=s.substring(m,c)),f&&f[1])l+=f[1];else{var p,d=-1;if(f){if(p="\\("==f[0]?"\\)":"\\["==f[0]?"\\]":f[0],u.lastIndex<s.length&&("$"!=f[0]||e.$mathQ))for(d=s.indexOf(p,u.lastIndex);-1!=d&&"\\"==s.charAt(d-1);)d=s.indexOf(p,d+1);if(-1==d){l+=f[0];continue}}if(l&&(o.push(i.createTextNode(l)),l=""),!f)break;var h="$$"==f[0]||"\\["==f[0],g=e.sToMathE(s.substring(u.lastIndex,d),h,i);if(h&&e.inline$$Q&&E.elem(t.parentNode.nodeName,["P","SPAN"])){var v=D("<div/>",i).css("display","inline-block").append(g);v=D("<span/>",i).css("white-space","nowrap").append(v),g=v[0]}o.push(g),u.lastIndex=d+p.length}}E.iter(function(e){t.parentNode.insertBefore(e,t)},o),t.parentNode.removeChild(t)}},e.parseMathQ=!0,D(function(){if(null==e.MathML&&(e.MathML=e.canMathML()),e.parseMathQ)try{e.parseMath(document.body)}catch(t){alert(t)}}),null==D.fn.parseMath&&(D.fn.parseMath=function(){return E.iter(e.parseMath,this),this}),e}(),M;void 0===M&&(M=jqMath);(function(a){function e(c,a){return"function"==typeof c?c.call(a):c}function d(c,e){this.$element=a(c);this.options=e;this.enabled=!0;this.fixTitle()}d.prototype={show:function(){var c=this.getTitle();if(c&&this.enabled){var d=this.tip();d.find(".tipsy-inner")[this.options.html?"html":"text"](c);d[0].className="tipsy";d.remove().css({top:0,left:0,visibility:"hidden",display:"block"}).prependTo(document.body);var c=a.extend({},this.$element.offset(),{width:this.$element[0].offsetWidth,height:this.$element[0].offsetHeight}),
g=d[0].offsetWidth,h=d[0].offsetHeight,k=e(this.options.gravity,this.$element[0]),l;switch(k.charAt(0)){case "n":l={top:c.top+c.height+this.options.offset,left:c.left+c.width/2-g/2};break;case "s":l={top:c.top-h-this.options.offset,left:c.left+c.width/2-g/2};break;case "e":l={top:c.top+c.height/2-h/2,left:c.left-g-this.options.offset};break;case "w":l={top:c.top+c.height/2-h/2,left:c.left+c.width+this.options.offset}}2==k.length&&("w"==k.charAt(1)?l.left=c.left+c.width/2-15:l.left=c.left+c.width/
2-g+15);d.css(l).addClass("tipsy-"+k);d.find(".tipsy-arrow")[0].className="tipsy-arrow tipsy-arrow-"+k.charAt(0);this.options.className&&d.addClass(e(this.options.className,this.$element[0]));this.options.fade?d.stop().css({opacity:0,display:"block",visibility:"visible"}).animate({opacity:this.options.opacity}):d.css({visibility:"visible",opacity:this.options.opacity})}},hide:function(){this.options.fade?this.tip().stop().fadeOut(function(){a(this).remove()}):this.tip().remove()},fixTitle:function(){var c=
this.$element;(c.attr("title")||"string"!=typeof c.attr("original-title"))&&c.attr("original-title",c.attr("title")||"").removeAttr("title")},getTitle:function(){var c,a=this.$element,d=this.options;this.fixTitle();d=this.options;"string"==typeof d.title?c=a.attr("title"==d.title?"original-title":d.title):"function"==typeof d.title&&(c=d.title.call(a[0]));return(c=(""+c).replace(/(^\s*|\s*$)/,""))||d.fallback},tip:function(){this.$tip||(this.$tip=a('<div class="tipsy"></div>').html('<div class="tipsy-arrow"></div><div class="tipsy-inner"></div>'));
return this.$tip},validate:function(){this.$element[0].parentNode||(this.hide(),this.options=this.$element=null)},enable:function(){this.enabled=!0},disable:function(){this.enabled=!1},toggleEnabled:function(){this.enabled=!this.enabled}};a.fn.tipsy=function(c){function e(f){var g=a.data(f,"tipsy");g||(g=new d(f,a.fn.tipsy.elementOptions(f,c)),a.data(f,"tipsy",g));return g}function g(){var a=e(this);a.hoverState="in";0==c.delayIn?a.show():(a.fixTitle(),setTimeout(function(){"in"==a.hoverState&&a.show()},
c.delayIn))}function h(){var a=e(this);a.hoverState="out";0==c.delayOut?a.hide():setTimeout(function(){"out"==a.hoverState&&a.hide()},c.delayOut)}if(!0===c)return this.data("tipsy");if("string"==typeof c){var k=this.data("tipsy");if(k)k[c]();return this}c=a.extend({},a.fn.tipsy.defaults,c);c.live||this.each(function(){e(this)});if("manual"!=c.trigger){var k=c.live?"live":"bind",l="hover"==c.trigger?"mouseleave":"blur";this[k]("hover"==c.trigger?"mouseenter":"focus",g)[k](l,h)}return this};a.fn.tipsy.defaults=
{className:null,delayIn:0,delayOut:0,fade:!1,fallback:"",gravity:"n",html:!1,live:!1,offset:0,opacity:.8,title:"title",trigger:"hover"};a.fn.tipsy.elementOptions=function(c,d){return a.metadata?a.extend({},d,a(c).metadata()):d};a.fn.tipsy.autoNS=function(){return a(this).offset().top>a(document).scrollTop()+a(window).height()/2?"s":"n"};a.fn.tipsy.autoWE=function(){return a(this).offset().left>a(document).scrollLeft()+a(window).width()/2?"e":"w"};a.fn.tipsy.autoBounds=function(c,d){return function(){var e=
d[0],h=1<d.length?d[1]:!1,k=a(document).scrollTop()+c,l=a(document).scrollLeft()+c,q=a(this);q.offset().top<k&&(e="n");q.offset().left<l&&(h="w");a(window).width()+a(document).scrollLeft()-q.offset().left<c&&(h="e");a(window).height()+a(document).scrollTop()-q.offset().top<c&&(e="s");return e+(h?h:"")}}})(jQuery);(function(a,e,d,c){function f(a,d){return a[d]===c?r[d]:a[d]}function g(){var a=e.pageYOffset;return a===c?y.scrollTop:a}function h(a,c){var d=r["on"+a];d&&(D(d)?d.call(c[0]):(d.addClass&&c.addClass(d.addClass),d.removeClass&&c.removeClass(d.removeClass)));c.trigger("lazy"+a,[c]);n()}function k(c){h(c.type,a(this).off("load error",k))}function l(c){if(z.length){c=c||r.forceLoad;B=Infinity;var d=g(),f=e.innerHeight||y.clientHeight,q=e.innerWidth||y.clientWidth,l,n;l=0;for(n=z.length;l<n;l++){var w=
z[l],u=w[0],v=w.lazyLoadXT,m=!1,p=c||0>C(u,"lazied"),t;if(!a.contains(y,u))m=!0;else if(c||!v.visibleOnly||u.offsetWidth||u.offsetHeight){if(!p){var p=u.getBoundingClientRect(),A=v.edgeX,x=v.edgeY;t=p.top+d-x-f;p=t<=d&&p.bottom>-x&&p.left<=q+A&&p.right>-A}if(p){w.on("load error",k);h("show",w);v=v.srcAttr;if(w=D(v)?v(w):u.getAttribute(v))u.src=w;m=!0}else t<B&&(B=t)}m&&(C(u,"lazied",0),z.splice(l--,1),n--)}n||h("complete",a(y))}}function q(){1<t?(t=1,l(),setTimeout(q,r.throttle)):t=0}function n(a){!z.length||
a&&"scroll"===a.type&&a.currentTarget===e&&B>=g()||(t||setTimeout(q,0),t=2)}function A(){x.lazyLoadXT()}function m(){l(!0)}var y=d.documentElement||d.body,r={autoInit:!0,selector:"img[data-src]",blankImage:"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",throttle:99,forceLoad:e.onscroll===c||!!e.operamini||!y.getBoundingClientRect,loadEvent:"pageshow",updateEvent:"load orientationchange resize scroll touchmove focus",forceEvent:"lazyloadall",oninit:{removeClass:"lazy"},
onshow:{addClass:"lazy-hidden"},onload:{removeClass:"lazy-hidden",addClass:"lazy-loaded"},onerror:{removeClass:"lazy-hidden"},checkDuplicates:!0},E={srcAttr:"data-src",edgeX:0,edgeY:0,visibleOnly:!0},x=a(e),D=a.isFunction,F=a.extend,C=a.data||function(c,d){return a(c).data(d)},z=[],B=0,t=0;a.lazyLoadXT=F(r,E,a.lazyLoadXT);a.fn.lazyLoadXT=function(c){c=c||{};var d=f(c,"blankImage"),g=f(c,"checkDuplicates"),k=f(c,"scrollContainer"),q=f(c,"show"),l={},m;a(k).on("scroll",n);for(m in E)l[m]=f(c,m);return this.each(function(f,
k){if(k===e)a(r.selector).lazyLoadXT(c);else{var m=g&&C(k,"lazied"),p=a(k).data("lazied",q?-1:1);m||(d&&"IMG"===k.tagName&&!k.src&&(k.src=d),p.lazyLoadXT=F({},l),h("init",p),z.push(p));n()}})};a(d).ready(function(){h("start",x);x.on(r.updateEvent,n).on(r.forceEvent,m);a(d).on(r.updateEvent,n);r.autoInit&&(x.on(r.loadEvent,A),A())})})(window.jQuery||window.Zepto||window.$,window,document);var skel=function(){var a={breakpointIds:null,events:{},isInit:!1,obj:{attachments:{},breakpoints:{},head:null,states:{}},sd:"/",state:null,stateHandlers:{},stateId:"",vars:{},DOMReady:null,indexOf:null,isArray:null,iterate:null,matchesMedia:null,extend:function(e,d){a.iterate(d,function(c){a.isArray(d[c])?(a.isArray(e[c])||(e[c]=[]),a.extend(e[c],d[c])):"object"==typeof d[c]?("object"!=typeof e[c]&&(e[c]={}),a.extend(e[c],d[c])):e[c]=d[c]})},newStyle:function(a){var d=document.createElement("style");
d.type="text/css";d.innerHTML=a;return d},_canUse:null,canUse:function(e){a._canUse||(a._canUse=document.createElement("div"));var d=a._canUse.style,c=e.charAt(0).toUpperCase()+e.slice(1);return e in d||"Moz"+c in d||"Webkit"+c in d||"O"+c in d||"ms"+c in d},on:function(e,d){var c=e.split(/[\s]+/);a.iterate(c,function(e){e=c[e];if(a.isInit){if("init"==e){d();return}if("change"==e)d();else{var g=e.charAt(0);if("+"==g||"!"==g){var h=e.substring(1);if(h in a.obj.breakpoints)if("+"==g&&a.obj.breakpoints[h].active)d();
else if("!"==g&&!a.obj.breakpoints[h].active){d();return}}}}a.events[e]||(a.events[e]=[]);a.events[e].push(d)});return a},trigger:function(e){if(a.events[e]&&0!=a.events[e].length)return a.iterate(a.events[e],function(d){a.events[e][d]()}),a},breakpoint:function(e){return a.obj.breakpoints[e]},breakpoints:function(e){function d(a,d){this.name=this.id=a;this.media=d;this.wasActive=this.active=!1}d.prototype.matches=function(){return a.matchesMedia(this.media)};d.prototype.sync=function(){this.wasActive=
this.active;this.active=this.matches()};a.iterate(e,function(c){a.obj.breakpoints[c]=new d(c,e[c])});window.setTimeout(function(){a.poll()},0);return a},addStateHandler:function(e,d){a.stateHandlers[e]=d},callStateHandler:function(e){var d=a.stateHandlers[e]();a.iterate(d,function(c){a.state.attachments.push(d[c])})},changeState:function(e){a.iterate(a.obj.breakpoints,function(d){a.obj.breakpoints[d].sync()});a.vars.lastStateId=a.stateId;a.stateId=e;a.breakpointIds=a.stateId===a.sd?[]:a.stateId.substring(1).split(a.sd);
console.log('[skel] changing states (id: "'+a.stateId+'")');a.obj.states[a.stateId]?(console.log("[skel] - found"),a.state=a.obj.states[a.stateId]):(console.log("[skel] - not found. building ..."),a.obj.states[a.stateId]={attachments:[]},a.state=a.obj.states[a.stateId],a.iterate(a.stateHandlers,a.callStateHandler));a.detachAll(a.state.attachments);a.attachAll(a.state.attachments);a.vars.stateId=a.stateId;a.vars.state=a.state;a.trigger("change");a.iterate(a.obj.breakpoints,function(d){a.obj.breakpoints[d].active?
a.obj.breakpoints[d].wasActive||a.trigger("+"+d):a.obj.breakpoints[d].wasActive&&a.trigger("-"+d)})},generateStateConfig:function(e,d){var c={};a.extend(c,e);a.iterate(a.breakpointIds,function(e){a.extend(c,d[a.breakpointIds[e]])});return c},getStateId:function(){var e="";a.iterate(a.obj.breakpoints,function(d){d=a.obj.breakpoints[d];d.matches()&&(e+=a.sd+d.id)});return e},poll:function(){var e="",e=a.getStateId();""===e&&(e=a.sd);e!==a.stateId&&a.changeState(e)},_attach:null,attach:function(e){var d=
a.obj.head,c=e.element;if(c.parentNode&&c.parentNode.tagName)return!1;a._attach||(a._attach=d.firstChild);d.insertBefore(c,a._attach.nextSibling);e.permanent&&(a._attach=c);console.log("[skel] "+e.id+": attached ("+e.priority+")");return!0},attachAll:function(e){var d=[];a.iterate(e,function(a){d[e[a].priority]||(d[e[a].priority]=[]);d[e[a].priority].push(e[a])});d.reverse();a.iterate(d,function(c){a.iterate(d[c],function(e){a.attach(d[c][e])})})},detach:function(a){var d=a.element;if(a.permanent||
!d.parentNode||d.parentNode&&!d.parentNode.tagName)return!1;d.parentNode.removeChild(d);return!0},detachAll:function(e){var d={};a.iterate(e,function(a){d[e[a].id]=!0});a.iterate(a.obj.attachments,function(c){c in d||a.detach(a.obj.attachments[c])})},attachment:function(e){return e in a.obj.attachments?a.obj.attachments[e]:null},newAttachment:function(e,d,c,f){return a.obj.attachments[e]={id:e,element:d,priority:c,permanent:f}},init:function(){a.initMethods();a.initVars();a.initEvents();a.obj.head=
document.getElementsByTagName("head")[0];a.isInit=!0;a.trigger("init");console.log("[skel] initialized.")},initEvents:function(){a.on("resize",function(){a.poll()});a.on("orientationChange",function(){a.poll()});a.DOMReady(function(){a.trigger("ready")});if(window.onload)a.on("load",window.onload);window.onload=function(){a.trigger("load")};if(window.onresize)a.on("resize",window.onresize);window.onresize=function(){a.trigger("resize")};if(window.onorientationchange)a.on("orientationChange",window.onorientationchange);
window.onorientationchange=function(){a.trigger("orientationChange")}},initMethods:function(){document.addEventListener?!function(e,d){a.DOMReady=d()}("domready",function(){var a=[],d,c=document,f=/^loaded|^c/.test(c.readyState);return c.addEventListener("DOMContentLoaded",d=function(){c.removeEventListener("DOMContentLoaded",d);var g=void 0;for(f=1;g=a.shift();)g()}),function(c){f?c():a.push(c)}}):!function(e,d){a.DOMReady=d()}("domready",function(a){function d(a){for(l=1;a=c.shift();)a()}var c=
[],f,g=document,h=g.documentElement,k=h.doScroll,l=(k?/^loaded|^c/:/^loaded|c/).test(g.readyState);return g.addEventListener&&g.addEventListener("DOMContentLoaded",f=function(){g.removeEventListener("DOMContentLoaded",f,!1);d()},!1),k&&g.attachEvent("onreadystatechange",f=function(){/^c/.test(g.readyState)&&(g.detachEvent("onreadystatechange",f),d())}),a=k?function(d){self!=top?l?d():c.push(d):function(){try{h.doScroll("left")}catch(c){return setTimeout(function(){a(d)},50)}d()}()}:function(a){l?
a():c.push(a)}});a.indexOf=Array.prototype.indexOf?function(a,d){return a.indexOf(d)}:function(a,d){if("string"==typeof a)return a.indexOf(d);var c;c=d?d:0;var f;if(!this)throw new TypeError;f=this.length;if(0===f||c>=f)return-1;for(0>c&&(c=f-Math.abs(c));c<f;c++)if(this[c]===a)return c;return-1};a.isArray=Array.isArray?function(a){return Array.isArray(a)}:function(a){return"[object Array]"===Object.prototype.toString.call(a)};a.iterate=Object.keys?function(a,d){if(!a)return[];var c,f=Object.keys(a);
for(c=0;f[c]&&!1!==d(f[c],a[f[c]]);c++);}:function(a,d){if(!a)return[];for(var c in a)if(Object.prototype.hasOwnProperty.call(a,c)&&!1===d(c,a[c]))break};a.matchesMedia=window.matchMedia?function(a){return""==a?!0:window.matchMedia(a).matches}:window.styleMedia||window.media?function(a){return""==a?!0:(window.styleMedia||window.media).matchMedium(a||"all")}:window.getComputedStyle?function(a){if(""==a)return!0;var d=document.createElement("style"),c=document.getElementsByTagName("script")[0],f=null;
d.type="text/css";d.id="matchmediajs-test";c.parentNode.insertBefore(d,c);f="getComputedStyle"in window&&window.getComputedStyle(d,null)||d.currentStyle;a="@media "+a+"{ #matchmediajs-test { width: 1px; } }";d.styleSheet?d.styleSheet.cssText=a:d.textContent=a;return"1px"===f.width}:function(a){if(""==a)return!0;var d,c,f={"min-width":null,"max-width":null},g=!1;c=a.split(/\s+and\s+/);for(a=0;a<c.length;a++)d=c[a],"("==d.charAt(0)&&(d=d.substring(1,d.length-1),d=d.split(/:\s+/),2==d.length&&(f[d[0].replace(/^\s+|\s+$/g,
"")]=parseInt(d[1]),g=!0));if(!g)return!1;g=document.documentElement.clientWidth;a=document.documentElement.clientHeight;return null!==f["min-width"]&&g<f["min-width"]||null!==f["max-width"]&&g>f["max-width"]||null!==f["min-height"]&&a<f["min-height"]||null!==f["max-height"]&&a>f["max-height"]?!1:!0};navigator.userAgent.match(/MSIE ([0-9]+)/)&&9>RegExp.$1&&(a.newStyle=function(a){var d=document.createElement("span");d.innerHTML='&nbsp;<style type="text/css">'+a+"</style>";return d})},initVars:function(){var e,
d,c,f=navigator.userAgent;e="other";d=0;c=[["firefox",/Firefox\/([0-9\.]+)/],["bb",/BlackBerry.+Version\/([0-9\.]+)/],["bb",/BB[0-9]+.+Version\/([0-9\.]+)/],["opera",/OPR\/([0-9\.]+)/],["opera",/Opera\/([0-9\.]+)/],["edge",/Edge\/([0-9\.]+)/],["safari",/Version\/([0-9\.]+).+Safari/],["chrome",/Chrome\/([0-9\.]+)/],["ie",/MSIE ([0-9]+)/],["ie",/Trident\/.+rv:([0-9]+)/]];a.iterate(c,function(a,c){if(f.match(c[1]))return e=c[0],d=parseFloat(RegExp.$1),!1});a.vars.browser=e;a.vars.browserVersion=d;e=
"other";d=0;c=[["ios",/([0-9_]+) like Mac OS X/,function(a){return a.replace("_",".").replace("_","")}],["ios",/CPU like Mac OS X/,function(a){return 0}],["android",/Android ([0-9\.]+)/,null],["mac",/Macintosh.+Mac OS X ([0-9_]+)/,function(a){return a.replace("_",".").replace("_","")}],["wp",/Windows Phone ([0-9\.]+)/,null],["windows",/Windows NT ([0-9\.]+)/,null],["bb",/BlackBerry.+Version\/([0-9\.]+)/,null],["bb",/BB[0-9]+.+Version\/([0-9\.]+)/,null]];a.iterate(c,function(a,c){if(f.match(c[1]))return e=
c[0],d=parseFloat(c[2]?c[2](RegExp.$1):RegExp.$1),!1});a.vars.os=e;a.vars.osVersion=d;a.vars.IEVersion="ie"==a.vars.browser?a.vars.browserVersion:99;a.vars.touch="wp"==a.vars.os?0<navigator.msMaxTouchPoints:!!("ontouchstart"in window);a.vars.mobile="wp"==a.vars.os||"android"==a.vars.os||"ios"==a.vars.os||"bb"==a.vars.os}};a.init();return a}();(function(a,e){"function"===typeof define&&define.amd?define([],e):"object"===typeof exports?module.exports=e():a.skel=e()})(this,function(){return skel});(function(a){a.fn.navList=function(){$a=a(this).find("a");b=[];$a.each(function(){var e=a(this),d=Math.max(0,e.parents("li").length-1),c=e.attr("href"),f=e.attr("target");b.push('<a class="link depth-'+d+'"'+("undefined"!==typeof f&&""!=f?' target="'+f+'"':"")+("undefined"!==typeof c&&""!=c?' href="'+c+'"':"")+'><span class="indent-'+d+'"></span>'+e.text()+"</a>")});return b.join("")};a.fn.panel=function(e){if(0==this.length)return c;if(1<this.length){for(var d=0;d<this.length;d++)a(this[d]).panel(e);
return c}var c=a(this),d=a("body"),f=a(window),g=c.attr("id"),h;h=a.extend({delay:0,hideOnClick:!1,hideOnEscape:!1,hideOnSwipe:!1,resetScroll:!1,resetForms:!1,side:null,target:c,visibleClass:"visible"},e);"jQuery"!=typeof h.target&&(h.target=a(h.target));c._hide=function(a){h.target.hasClass(h.visibleClass)&&(a&&(a.preventDefault(),a.stopPropagation()),h.target.removeClass(h.visibleClass),window.setTimeout(function(){h.resetScroll&&c.scrollTop(0);h.resetForms&&c.find("form").each(function(){this.reset()})},
h.delay))};c.css("-ms-overflow-style","-ms-autohiding-scrollbar").css("-webkit-overflow-scrolling","touch");h.hideOnClick&&(c.find("a").css("-webkit-tap-highlight-color","rgba(0,0,0,0)"),c.on("click","a",function(d){var e=a(this),f=e.attr("href"),n=e.attr("target");f&&"#"!=f&&""!=f&&f!="#"+g&&(d.preventDefault(),d.stopPropagation(),c._hide(),window.setTimeout(function(){"_blank"==n?window.open(f):window.location.href=f},h.delay+10))}));c.on("touchstart",function(a){c.touchPosX=a.originalEvent.touches[0].pageX;
c.touchPosY=a.originalEvent.touches[0].pageY});c.on("touchmove",function(a){if(null!==c.touchPosX&&null!==c.touchPosY){var d=c.touchPosX-a.originalEvent.touches[0].pageX,e=c.touchPosY-a.originalEvent.touches[0].pageY,f=c.outerHeight(),g=c.get(0).scrollHeight-c.scrollTop();if(h.hideOnSwipe){var m=!1;switch(h.side){case "left":m=20>e&&-20<e&&50<d;break;case "right":m=20>e&&-20<e&&-50>d;break;case "top":m=20>d&&-20<d&&50<e;break;case "bottom":m=20>d&&-20<d&&-50>e}if(m)return c.touchPosX=null,c.touchPosY=
null,c._hide(),!1}if(0>c.scrollTop()&&0>e||g>f-2&&g<f+2&&0<e)a.preventDefault(),a.stopPropagation()}});c.on("click touchend touchstart touchmove",function(a){a.stopPropagation()});c.on("click",'a[href="#'+g+'"]',function(a){a.preventDefault();a.stopPropagation();h.target.removeClass(h.visibleClass)});d.on("click touchend",function(a){c._hide(a)});d.on("click",'a[href="#'+g+'"]',function(a){a.preventDefault();a.stopPropagation();h.target.toggleClass(h.visibleClass)});if(h.hideOnEscape)f.on("keydown",
function(a){27==a.keyCode&&c._hide(a)});return c};a.fn.placeholder=function(){if("undefined"!=typeof document.createElement("input").placeholder)return a(this);if(0==this.length)return d;if(1<this.length){for(var e=0;e<this.length;e++)a(this[e]).placeholder();return d}var d=a(this);d.find("input[type=text],textarea").each(function(){var c=a(this);""!=c.val()&&c.val()!=c.attr("placeholder")||c.addClass("polyfill-placeholder").val(c.attr("placeholder"))}).on("blur",function(){var c=a(this);c.attr("name").match(/-polyfill-field$/)||
""==c.val()&&c.addClass("polyfill-placeholder").val(c.attr("placeholder"))}).on("focus",function(){var c=a(this);c.attr("name").match(/-polyfill-field$/)||c.val()==c.attr("placeholder")&&c.removeClass("polyfill-placeholder").val("")});d.find("input[type=password]").each(function(){var c=a(this),d=a(a("<div>").append(c.clone()).remove().html().replace(/type="password"/i,'type="text"').replace(/type=password/i,"type=text"));""!=c.attr("id")&&d.attr("id",c.attr("id")+"-polyfill-field");""!=c.attr("name")&&
d.attr("name",c.attr("name")+"-polyfill-field");d.addClass("polyfill-placeholder").val(d.attr("placeholder")).insertAfter(c);""==c.val()?c.hide():d.hide();c.on("blur",function(a){a.preventDefault();a=c.parent().find("input[name="+c.attr("name")+"-polyfill-field]");""==c.val()&&(c.hide(),a.show())});d.on("focus",function(a){a.preventDefault();a=d.parent().find("input[name="+d.attr("name").replace("-polyfill-field","")+"]");d.hide();a.show().focus()}).on("keypress",function(a){a.preventDefault();d.val("")})});
d.on("submit",function(){d.find("input[type=text],input[type=password],textarea").each(function(c){c=a(this);c.attr("name").match(/-polyfill-field$/)&&c.attr("name","");c.val()==c.attr("placeholder")&&(c.removeClass("polyfill-placeholder"),c.val(""))})}).on("reset",function(c){c.preventDefault();d.find("select").val(a("option:first").val());d.find("input,textarea").each(function(){var c=a(this),d;c.removeClass("polyfill-placeholder");switch(this.type){case "submit":case "reset":break;case "password":c.val(c.attr("defaultValue"));
d=c.parent().find("input[name="+c.attr("name")+"-polyfill-field]");""==c.val()?(c.hide(),d.show()):(c.show(),d.hide());break;case "checkbox":case "radio":c.attr("checked",c.attr("defaultValue"));break;case "text":case "textarea":c.val(c.attr("defaultValue"));""==c.val()&&(c.addClass("polyfill-placeholder"),c.val(c.attr("placeholder")));break;default:c.val(c.attr("defaultValue"))}})});return d};a.prioritize=function(e,d){"jQuery"!=typeof e&&(e=a(e));e.each(function(){var c=a(this),e,g=c.parent();0!=
g.length&&(c.data("__prioritize")?d||(e=c.data("__prioritize"),c.insertAfter(e),c.removeData("__prioritize")):d&&(e=c.prev(),0!=e.length&&(c.prependTo(g),c.data("__prioritize",e))))})}})(jQuery);(function(a){skel.breakpoints({xlarge:"(max-width: 1680px)",large:"(max-width: 1280px)",medium:"(max-width: 1024px)",small:"(max-width: 736px)",xsmall:"(max-width: 480px)"});a(function(){var e=a("body");a("#header");var d=a("#nav").find("a");a("#wrapper");a("form").placeholder();skel.on("+medium -medium",function(){a.prioritize(".important\\28 medium\\29",skel.breakpoint("medium").active)});var c=[];d.add('a[class$="-link"]').scrolly({offset:44}).on("click",function(c){var e=a(this).attr("href");
"#"==e.charAt(0)&&(c.preventDefault(),d.removeClass("active").addClass("scrollzer-locked"),d.filter('a[href="'+e+'"]').addClass("active"))}).each(function(){var d=a(this),e=d.attr("href");"#"==e.charAt(0)&&(e=e.substring(1),d.attr("id",e+"-link"),c.push(e))});a.scrollzer(c,{pad:300,lastHack:!0});a('<div id="titleBar"><a href="#header" class="toggle"></a><span class="title">'+a("#logo").html()+"</span></div>").appendTo(e);a("#header").panel({delay:500,hideOnClick:!0,hideOnSwipe:!0,resetScroll:!0,resetForms:!0,
side:"right",target:e,visibleClass:"header-visible"});"wp"==skel.vars.os&&10>skel.vars.osVersion&&a("#titleBar, #header, #wrapper").css("transition","none")})})(jQuery);
